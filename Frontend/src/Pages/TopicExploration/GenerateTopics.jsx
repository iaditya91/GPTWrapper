...
const GenerateTopics = () => {
  const GENERATE_TOPICS_URL = "/generate_topics_sample";
      ...
      {loading ? (
        ...
        >
          <section style={{ justifyContent: "center" }}>
            <h1 style={{ color: "black" }}>Generate Topics</h1>
            <br />
            <p style={{ color: "black" }}>
